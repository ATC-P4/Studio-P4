...
m_p: cls2.Project = None #main project object, holds the project settings and tracks
s_t: cls2.Track = None #selected track object, holds the track settings and MIDI data
