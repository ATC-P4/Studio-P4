...
class VirtualMidiController(QWidget):
    ...
    def init_ui(self):
        ...
        for name, midi_note in notes.items():
            ...
            # Use pressed/released to simulate true piano key behavior
